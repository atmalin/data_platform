...
public final class DownloadUtil {
    ...
    public static void download(String downloadDir, String downloadFileName, HttpServletResponse response) throws Exception {
        String[] allowFileExtensionArrays = {"jpg","png","docx","xlsx","pptx","pdf"};
        List<String> allowFileExtensions = Arrays.asList(allowFileExtensionArrays);
        download(downloadDir, downloadFileName, allowFileExtensions, response);
    }
