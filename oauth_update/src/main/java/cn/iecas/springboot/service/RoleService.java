...
//    }
    ...
    public ApiResult<RoleBean> modify(RoleAdd roleAdd){
        //检验角色是否存在
        if(!roleDao.existsById(roleAdd.getRoleId())){
        ...
        Example<RolePermissionBean> example = Example.of(rolePermissionBean);
        rolePermissionDao.deleteInBatch(rolePermissionDao.findAll(example));
